...
bootstrap(TrainerAppComponent, [
    ...
    provideForms(),
    HTTP_PROVIDERS, APP_ROUTER_PROVIDERS, ExerciseBuilderService, WorkoutHistoryTracker, WorkoutBuilderService, WorkoutService, LocalStorage, MODAL_BROWSER_PROVIDERS
]);