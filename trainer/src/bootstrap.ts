...
import { HTTP_PROVIDER S} from '@angular/http';
...
bootstrap(TrainerAppComponent, [ROUTER_PROVIDERS, ExerciseBuilderService, WorkoutHistoryTracker, WorkoutBuilderService, WorkoutService, LocalStorage, MODAL_BROWSER_PROVIDERS]);